...
```text
backend/           Django REST API and MongoDB documents
frontend/          Next.js application
docker-compose.yml MongoDB, backend, and frontend services
DOCKER-START.md    Detailed Docker setup and troubleshooting
ARCHITECTURE.md    Design and authorization decisions
```
